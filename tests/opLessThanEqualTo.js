...
assert.strictEqual( opLessThanEqualTo( "20210101", [ 2021, 1, 2 ] ), true, 'opLessThanEqualTo( "20210101", [ 2021, 1, 2 ] )' );
assert.strictEqual( opLessThanEqualTo( "01/01/2021", new Date( 2021, 0 ,2 ) ), true, 'opLessThanEqualTo( "01/01/2021", new Date( 2021, 0 , 2 ) )' );

assert.strictEqual( opLessThanEqualTo( "20210102", [ 2021, 1, 2 ] ), true, 'opLessThanEqualTo( "20210102", [ 2021, 1, 2 ] )' );
assert.strictEqual( opLessThanEqualTo( "02/01/2021", new Date( 2021, 0 ,2 ) ), true, 'opLessThanEqualTo( "02/01/2021", new Date( 2021, 0 , 2 ) )' );

assert.strictEqual( opLessThanEqualTo( "20210103", [ 2021, 1, 2 ] ), false, 'opLessThanEqualTo( "20210103", [ 2021, 1, 2 ] )' );
