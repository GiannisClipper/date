...
assert.strictEqual( opGreaterThanEqualTo( "20210101", [ 2, 1, 2021 ] ), false, 'opGreaterThanEqualTo( "20210101", [ 2, 1, 2021 ] )' );
...
assert.strictEqual( opGreaterThanEqualTo( "20210102", [ 2, 1, 2021 ] ), true, 'opGreaterThanEqualTo( "20210102", [ 2, 1, 2021 ] )' );
...
assert.strictEqual( opGreaterThanEqualTo( "20210103", [ 2, 1, 2021 ] ), true, 'opGreaterThanEqualTo( "20210103", [ 2, 1, 2021 ] )' );
