...
assert.strictEqual( opEqualTo( "20210101", [ 2021, 1, 2 ] ), false, 'opEqualTo( "20210101", [ 2021, 1, 2 ] )' );
assert.strictEqual( opEqualTo( "01/01/2021", new Date( 2021, 0 , 2 ) ), false, 'opEqualTo( "01/01/2021", new Date( 2021, 0 , 2 ) )' );

assert.strictEqual( opEqualTo( "20210102", [ 2021, 1, 2 ] ), true, 'opEqualTo( "20210102", [ 2021, 1, 2 ] )' );
assert.strictEqual( opEqualTo( "02/01/2021", new Date( 2021, 0 , 2 ) ), true, 'opEqualTo( "02/01/2021", new Date( 2021, 0 , 2 ) )' );

assert.strictEqual( opEqualTo( "20210103", [ 2021, 1, 2 ] ), false, 'opEqualTo( "20210103", [ 2021, 1, 2 ] )' );
