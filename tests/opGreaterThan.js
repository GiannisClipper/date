...
assert.strictEqual( opGreaterThan( "20210101", [ 2021, 1, 2 ] ), false, 'opGreaterThan( "20210101", [ 2021, 1, 2 ] )' );
assert.strictEqual( opGreaterThan( "01/01/2021", new Date( 2021, 0 ,2 ) ), false, 'opGreaterThan( "01/01/2021", new Date( 2021, 0 , 2 ) )' );

assert.strictEqual( opGreaterThan( "20210102", [ 2021, 1, 2 ] ), false, 'opGreaterThan( "20210102", [ 2021, 1, 2 ] )' );
assert.strictEqual( opGreaterThan( "02/01/2021", new Date( 2021, 0 ,2 ) ), false, 'opGreaterThan( "02/01/2021", new Date( 2021, 0 , 2 ) )' );

assert.strictEqual( opGreaterThan( "20210103", [ 2021, 1, 2 ] ), true, 'opGreaterThan( "20210103", [ 2021, 1, 2 ] )' );
