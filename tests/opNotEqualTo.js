...
assert.strictEqual( opNotEqualTo( "20210101", [ 2021, 1, 2 ] ), true, 'opNotEqualTo( "20210101", [ 2021, 1, 2 ] )' );
assert.strictEqual( opNotEqualTo( "01/01/2021", new Date( 2021, 0 ,2 ) ), true, 'opNotEqualTo( "01/01/2021", new Date( 2021, 0 , 2 ) )' );

assert.strictEqual( opNotEqualTo( "20210102", [ 2021, 1, 2 ] ), false, 'opNotEqualTo( "20210102", [ 2021, 1, 2 ] )' );
assert.strictEqual( opNotEqualTo( "02/01/2021", new Date( 2021, 0 ,2 ) ), false, 'opNotEqualTo( "02/01/2021", new Date( 2021, 0 , 2 ) )' );

assert.strictEqual( opNotEqualTo( "20210103", [ 2021, 1, 2 ] ), true, 'opNotEqualTo( "20210103", [ 2021, 1, 2 ] )' );
