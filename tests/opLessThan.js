...
assert.strictEqual( opLessThan( "20210101", [ 2021, 1, 2 ] ), true, 'opLessThan( "20210101", [ 2021, 1, 2 ] )' );
assert.strictEqual( opLessThan( "01/01/2021", new Date( 2021, 0 ,2 ) ), true, 'opLessThan( "01/01/2021", new Date( 2021, 0 , 2 ) )' );

assert.strictEqual( opLessThan( "20210102", [ 2021, 1, 2 ] ), false, 'opLessThan( "20210102", [ 2021, 1, 2 ] )' );
assert.strictEqual( opLessThan( "02/01/2021", new Date( 2021, 0 ,2 ) ), false, 'opLessThan( "02/01/2021", new Date( 2021, 0 , 2 ) )' );

assert.strictEqual( opLessThan( "20210103", [ 2021, 1, 2 ] ), false, 'opLessThan( "20210103", [ 2021, 1, 2 ] )' );
